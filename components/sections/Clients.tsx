...
export default function Clients() {
  ...
  return (
    <section className="border-y border-[#1e3a5f]/50 bg-[#0d1b2a]/70 py-12">
      <div className="container">
        ...
        <div className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
          {clients.map((client, index) => (
            <div key={client.name} className="client-logo group flex min-h-24 items-center justify-center gap-3 rounded-xl border border-[#1e3a5f]/70 bg-[#0d1b2a] px-4 transition hover:border-cyan-400/35 hover:bg-cyan-400/[0.04]" style={{ animationDelay: `${index * 100}ms` }}>
